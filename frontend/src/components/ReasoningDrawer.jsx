    ...
    <>
      ...
      <button
        ...
        style={{
          ...
          color: '#555', fontSize: '0.6875rem', fontWeight: 500, cursor: 'pointer',
      ...
      >
        <span style={{ fontSize: '0.5rem', color: 'inherit' }}>◎</span>
        View AI Reasoning
      </button>
        ...
        <div style={{ position: 'fixed', inset: 0, zIndex: 300, display: 'flex' }}>
          ...
          <div style={{
            ...
            <div style={{ padding: '1.25rem 1.5rem', borderBottom: '1px solid #2E2E2E', display: 'flex', alignItems: 'center', justifyContent: 'space-between', flexShrink: 0 }}>
              <div>
                <div style={{ fontSize: '0.875rem', fontWeight: 700, color: '#fff', marginBottom: '0.2rem' }}>AI Reasoning Trace</div>
                <div style={{ fontSize: '0.625rem', color: '#444', textTransform: 'uppercase', letterSpacing: '0.08em' }}>Accenture Responsible AI — Transparency Pillar</div>
              </div>
              <button onClick={() => setOpen(false)} style={{ background: 'none', border: 'none', color: '#555', fontSize: '1.25rem', cursor: 'pointer', lineHeight: 1, padding: '0.25rem' }}>×</button>
            </div>
            ...
            <div style={{ padding: '0.875rem 1.5rem', borderBottom: '1px solid #1E1E1E', display: 'flex', gap: '1.5rem', flexShrink: 0 }}>
              {[
                ...
                <div key={label}>
                  ...
                  <div style={{ fontSize: '0.75rem', fontWeight: 600, color: color ?? '#c8c8c4', fontFamily: 'ui-monospace, monospace' }}>{val}</div>
                </div>
              ))}
              {meta.screen1ContextInjected && (
                <div>
                  <div style={{ fontSize: '0.5rem', fontWeight: 700, color: '#444', textTransform: 'uppercase', letterSpacing: '0.08em', marginBottom: '0.2rem' }}>Context</div>
                  <div style={{ fontSize: '0.75rem', fontWeight: 600, color: '#00C896' }}>Screen 1 injected</div>
                </div>
              )}
            </div>
            ...
            <div style={{ margin: '1rem 1.5rem', padding: '0.75rem 1rem', background: '#AC00EF08', border: '1px solid #AC00EF25', borderRadius: '0.25rem' }}>
              <div style={{ fontSize: '0.625rem', fontWeight: 700, color: '#AC00EF', textTransform: 'uppercase', letterSpacing: '0.08em', marginBottom: '0.375rem' }}>Responsible AI — Transparency</div>
            ...
            <div style={{ padding: '0 1.5rem 1rem', flexShrink: 0 }}>
              ...
              >
                <span style={{ fontSize: '0.6875rem', fontWeight: 700, color: '#555', textTransform: 'uppercase', letterSpacing: '0.08em' }}>System Prompt</span>
                <span style={{ color: '#AC00EF', fontSize: '0.875rem' }}>{sysPExpand ? '−' : '+'}</span>
              </button>
              {sysPExpand && (
                <pre style={{ fontSize: '0.6875rem', color: '#555', lineHeight: 1.6, whiteSpace: 'pre-wrap', wordBreak: 'break-word', background: '#0A0A0A', border: '1px solid #1E1E1E', borderRadius: '0.25rem', padding: '0.75rem', margin: 0, fontFamily: 'ui-monospace, monospace', maxHeight: '300px', overflowY: 'auto' }}>
                  {meta.systemPrompt}
                </pre>
              )}
            </div>
            ...
            {/* User prompt */}
            <div style={{ padding: '0 1.5rem 1rem', flexShrink: 0 }}>
              <div style={{ fontSize: '0.6875rem', fontWeight: 700, color: '#555', textTransform: 'uppercase', letterSpacing: '0.08em', marginBottom: '0.5rem' }}>User Prompt (Sent to Claude)</div>
              <pre style={{ fontSize: '0.6875rem', color: '#c8c8c4', lineHeight: 1.6, whiteSpace: 'pre-wrap', wordBreak: 'break-word', background: '#0A0A0A', border: '1px solid #1E1E1E', borderRadius: '0.25rem', padding: '0.75rem', margin: 0, fontFamily: 'ui-monospace, monospace', maxHeight: '400px', overflowY: 'auto' }}>
                {meta.userPrompt}
              </pre>
            </div>
            ...
            <div style={{ padding: '0 1.5rem 1.5rem', flexShrink: 0 }}>
              <div style={{ fontSize: '0.6875rem', fontWeight: 700, color: '#555', textTransform: 'uppercase', letterSpacing: '0.08em', marginBottom: '0.5rem' }}>Data Assumptions</div>
              <div style={{ display: 'flex', flexDirection: 'column', gap: '0.375rem' }}>
                {[
                  ...
                  <div key={label} style={{ display: 'flex', gap: '0.75rem', alignItems: 'flex-start', padding: '0.4rem 0.625rem', background: `${color}08`, borderLeft: `2px solid ${color}40`, borderRadius: '0 2px 2px 0' }}>
                    ...
                    <span style={{ fontSize: '0.6875rem', color: '#787878', lineHeight: 1.4 }}>{val}</span>
                  </div>
                ))}
              </div>
            </div>
